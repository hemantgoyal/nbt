Refinery::Videos.configure do |config|
    ...
    # config.dragonfly_secret = b089031df160dec9cd4ade3da1d54cbc23dc077302a0c9e9
    # If you decide to trust file extensions replace :ext below with :format
    # config.dragonfly_url_format = /system/videos/:job/:basename.:format
    # config.datastore_root_path = /home/love/rails/nabblog1/public/system/refinery/videos
